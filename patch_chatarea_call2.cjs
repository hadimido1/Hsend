...
const callBlock = `          ) : msg.type === 'call_log' || msg.type === 'call' || msg.type === 'call_missed' || msg.content === 'Voice call' || msg.content === 'مكالمة فائتة' || msg.content === 'مكالمة صوتية' || msg.content === 'Missed call' || msg.content === 'No answer' ? (() => {
